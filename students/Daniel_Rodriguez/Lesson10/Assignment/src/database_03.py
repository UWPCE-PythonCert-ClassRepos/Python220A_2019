...
# Note: Run with 'python src/database_03.py' from Assignment directory
# via Command Prompt

# TODO: Time functions using metaprogramming (decorators)
# TODO: Write timing results to file
