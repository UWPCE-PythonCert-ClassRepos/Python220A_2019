...
"""
#Corresponds to second in series of files from first video Lesson 3, Part 3), there, this was implemented as a '
#function "select_and_update (around 5:37 of video)
...
logger.info(f'{aperson.person_name} lives in {aperson.lives_in_town} ' + \
    f' and likes to be known as {aperson.nickname}') #Similar formatting as in print!
...
cc=Person.select().where(Person.nickname !="Dave")
print(cc.columns()) #Seems to return SQL query corresponding to the expression
