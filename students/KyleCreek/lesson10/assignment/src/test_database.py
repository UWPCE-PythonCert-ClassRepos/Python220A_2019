...
from databse import import_data
from databse import show_available_products
from databse import show_rentals
...
class TestDatabase(TestCase):
    ...
    def test_import_data(self):
        ...
        direct = "C:\\Python220A_2019\\students\\KyleCreek\\lesson10\\assignment\\data\\"
        cust = "customer.csv"
        prod = "product.csv"
        rent = "rental.csv"
