    ...
    with open(filename) as csv_file:
        ...
        for row in reader:
            if 'ao' in row[6]:
                ao_count += 1
                continue
            elif row[4].__contains__('2013'):
                year_count['2013'] += 1
            elif row[4].__contains__('2014'):
                year_count['2014'] += 1
            elif row[4].__contains__('2015'):
                year_count['2015'] += 1
            elif row[4].__contains__('2016'):
                year_count['2016'] += 1
            elif row[4].__contains__('2017'):
                year_count['2017'] += 1
            elif row[4].__contains__('2018'):
                year_count['2018'] += 1
